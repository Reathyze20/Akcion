@echo off
rem ============================================================================
rem  Akcion - denni cteni Gomesova trackeru (riskrewardcharts.com)
rem ============================================================================
rem  Obalka pro scripts\tracker_poll.py, na kterou miri uloha v Planovaci
...
rem   4. INTERVAL. Spousteni castejsi nez jednou denne nic nezkazi: limit
rem      12 hodin je vynuceny v kodu (MIN_POLL_INTERVAL), ne planovacem.
rem      Cizi server se tim neprotoci ani kdyz nekdo ulohu preklikne.
rem
...
set "LOG=%LOGDIR%\tracker_poll.log"
...
%PYTHON% "%BACKEND%\scripts\tracker_poll.py" >> "%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
