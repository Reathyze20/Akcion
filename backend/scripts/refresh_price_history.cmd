@echo off
rem ============================================================================
rem  Akcion - denni historie cen do ohlcv_data
rem ============================================================================
rem  Obalka pro scripts\refresh_price_history.py, na kterou miri uloha v Planovaci
...
rem      probehla a zdroj byl nedostupny" jsou dve ruzne veci a bez logu je
rem      nerozeznas.
...
rem   4. INTERVAL. Denni bary se meni jednou za den, takze castejsi beh
rem      nic nepridava. Zapis je upsert, takze opakovany beh nic nerozbije.
rem
rem  K cemu to je: rubrika faze cyklu meri "propad od vrcholu" (kanon SS3).
rem  Drive to cetla z 52tydenniho maxima Yahoo, coz minulo kazdou tezi, ktera
rem  vrcholila pred vic nez rokem - a to maximum navic sedelo v cache, jejiz
rem  cenove pole zestarlo (ECOR drzel cervencovou cenu do konce srpna a udelal
rem  z 4% propadu 41%, coz otocilo verdikt z "drz" na "prodej").
rem
...
set "LOG=%LOGDIR%\price_history.log"
...
%PYTHON% "%BACKEND%\scripts\refresh_price_history.py" >> "%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
