@echo off
rem ============================================================================
rem  Akcion - denni cteni watchlistu Breakout Investors
rem ============================================================================
rem  Obalka pro scripts\breakout_poll.py, na kterou miri uloha v Planovaci
...
rem      20 hodin je vynuceny v kodu (MIN_POLL_INTERVAL), ne planovacem.
...
set "LOG=%LOGDIR%\breakout_poll.log"
...
%PYTHON% "%BACKEND%\scripts\breakout_poll.py" >> "%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
